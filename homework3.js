...
// const dates = users.filter(users => {
...
// const NewArray = data.filter((item,index) => index === data.indexOf(item) )
// console.table(NewArray)

// const NewArray = data.reduce((uniq, item) => {
//     return uniq.includes(item) ? uniq : [... uniq, item];

// }, [])
// console.table(NewArray)

// let NewArray = Array.from(new Set(data))
// console.table(NewArray)
